...
public class twinnine extends BaseActivity {

    Button b9;

    ImageView i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14,i15,i16,i17,i18,i19,i20,i21,i22,hm9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_twinnine);
        currentLevel =9;
        ...
        b9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (i1.getVisibility() == View.INVISIBLE &&
                    ...
                    Intent in2 = new Intent(twinnine.this, twinten.class);
                    startActivity(in2);

                } else {
                    Toast.makeText(twinnine.this, "Complete all matches before moving ahead!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        hm9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                AlertDialog.Builder builder = new AlertDialog.Builder(twinnine.this);
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(twinnine.this, OptScr.class);
