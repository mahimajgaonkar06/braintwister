...
public class twinone extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_twinone);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (i1.getVisibility() == View.INVISIBLE &&
                    ...
                    Intent in1 = new Intent(twinone.this, twintwo.class);
                    startActivity(in1);

                } else {
                    Toast.makeText(twinone.this, "Complete all matches before moving ahead!", Toast.LENGTH_SHORT).show();
                }
            }
        });
